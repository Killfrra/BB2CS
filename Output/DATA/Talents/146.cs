...
namespace Chars
{
    public class _146 : BBCharScript
    {
        public override void OnUpdateActions()
        {
            ...
            if(dotCheck == nameof(Spells.SummonerDot))
            {
                ...
                if(cooldown > 0)
                {
                    ...
                    {
                        AddBuff((ObjAIBase)owner, owner, new Buffs.BurningEmbers(), 1, 1, 25000, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0);
                    }
                }
                else
                {
                    SpellBuffRemove(owner, nameof(Buffs.BurningEmbers), (ObjAIBase)owner);
                }
            }
