...
namespace Items
{
    public class _3196 : BBItemScript
    {
        ...
        public override void OnUpdateActions()
        {
            ...
            {
                AddBuff((ObjAIBase)owner, owner, new Buffs.ViktorAugmentQ(), 1, 1, 4, BuffAddType.RENEW_EXISTING, BuffType.INTERNAL, 0, true, false, false);
            }
        }
    }
}