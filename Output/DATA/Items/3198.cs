...
namespace Items
{
    public class _3198 : BBItemScript
    {
        ...
        public override void OnUpdateActions()
        {
            ...
            {
                AddBuff((ObjAIBase)owner, owner, new Buffs.ViktorAugmentE(), 1, 1, 4, BuffAddType.RENEW_EXISTING, BuffType.INTERNAL, 0, true, false, false);
            }
        }
    }
}