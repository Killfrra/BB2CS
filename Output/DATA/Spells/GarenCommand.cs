...
namespace Spells
{
    public class GarenCommand : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            SpellEffectCreate(out this.particle, out _, "garen_command_cas.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, attacker, false, attacker, "C_BUFFBONE_GLB_CENTER_LOC", default, attacker, default, default, true, default, default, false, false);
...
namespace Buffs
{
    public class GarenCommand : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle, out _, "garen_commandingPresence_unit_buf_self.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "C_BUFFBONE_GLB_CHEST_LOC", default, owner, default, default, true, default, default, false, false);
