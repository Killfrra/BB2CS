    ...
    public class RenektonPreExecute : BBBuffScript
    {
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            if(!this.swung)
            {
                ...
                SpellEffectCreate(out temp, out _, "Renekton_RuthlessPredator_obd-sound.troy", default, ownerVar ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, default, default, false, false);
            }
        }
