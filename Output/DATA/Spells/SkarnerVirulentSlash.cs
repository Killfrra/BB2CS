...
namespace Spells
{
    public class SkarnerVirulentSlash : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            if(count == 0)
            {
                SpellEffectCreate(out this.partname, out _, "Skarner_Crystal_Slash_Mini_Nova.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, owner.Position, target, default, default, true, false, false, false, false);
            }
            else
            {
                SpellEffectCreate(out this.partname, out _, "Skarner_Crystal_Slash_Buf.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, owner.Position, target, default, default, true, false, false, false, false);
            }
            championHit = false;
            foreach(AttackableUnit unit in GetUnitsInArea((ObjAIBase)owner, owner.Position, 350, SpellDataFlags.AffectEnemies | SpellDataFlags.AffectNeutral | SpellDataFlags.AffectMinions | SpellDataFlags.AffectHeroes, default, true))
            {
                ...
                if(count == 0)
                {
                    SpellEffectCreate(out temp, out _, "chogath_basic_attack_01.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, unit, default, default, unit, default, default, true, false, false, false, false);
                }
                else
                {
                    ...
                    SpellEffectCreate(out temp, out _, "Skarner_Crystal_Slash_Tar.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, unit, default, default, unit, default, default, true, false, false, false, false);
