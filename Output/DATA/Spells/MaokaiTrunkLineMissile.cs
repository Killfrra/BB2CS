        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            if(GetBuffCountFromCaster(target, owner, nameof(Buffs.MaokaiTrunkLine)) == 0)
            {
                ...
                if(!isStealthed)
                {
                    ...
                    SpellEffectCreate(out asdf, out _, "maoki_trunkSmash_unit_tar_02.troy", default, casterID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true);
                    SpellEffectCreate(out asdf, out _, "maoki_trunkSmash_unit_tar.troy", default, casterID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true);
