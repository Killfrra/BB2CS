...
namespace Buffs
{
    public class FizzMarinerDoomBomb : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.temp2, out this.temp, "Fizz_Ring_Green.troy", "Fizz_Ring_Red.troy", teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, owner.Position, owner, default, default, true, false, true, false, false);
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            if(expired)
            {
                ...
                other3 = SpawnMinion("Omnomnomnom", "FizzShark", "idle.lua", targetPos, teamID, false, true, false, true, true, true, 0, false, false, (Champion)attacker);
