...
namespace Buffs
{
    public class BeaconAuraAP : BBBuffScript
    {
        ...
        public override void OnUpdateActions()
        {
            ...
            {
                AddBuffToEachUnitInArea(owner, owner.Position, 850, SpellDataFlags.AffectFriends | SpellDataFlags.AffectMinions | SpellDataFlags.AffectHeroes | SpellDataFlags.NotAffectSelf, attacker, new Buffs.BeaconAuraNoParticleAP(), BuffAddType.RENEW_EXISTING, BuffType.AURA, 1, 1, 1.1f, 0, false, true);
            }
        }
    }
}