...
namespace Spells
{
    public class LayWaste : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            other3 = SpawnMinion("SpellBook1", "SpellBook1", "idle.lua", targetPos, teamOfOwner ?? TeamId.TEAM_CASTER, false, true, false, true, true, true, 0, false, true, (Champion)owner);
...
namespace Buffs
{
    public class LayWaste : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle, out _, "LayWaste_point.troy", default, this.teamOfOwner ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, default, owner.Position, target, default, default, true, false, false, false, false);
        }
        public override void OnDeactivate(bool expired)
        {
            ...
            SpellEffectCreate(out particle, out _, "LayWaste_tar.troy", default, this.teamOfOwner ?? TeamId.TEAM_UNKNOWN, 200, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, default, owner.Position, target, default, default, true, false, false, false, false);
            numUnits = 0;
