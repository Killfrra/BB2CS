                ...
                else
                {
                    if(distance < 250)
                    {
                        if(IsInFront(owner, unit))
                        {
                            ...
                            {
                                SpellEffectCreate(out a, out _, "shyvana_doubleAttack_tar.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, unit, default, default, unit, default, default, true, false, false, false, false);
                            }
                        }
                    }
                }
