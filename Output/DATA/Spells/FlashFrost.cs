    ...
    public class FlashFrost : BBBuffScript
    {
        ...
        public override void OnMissileEnd(string spellName, Vector3 missileEndPosition)
        {
            ...
            if(spellName == nameof(Spells.FlashFrostSpell))
            {
                ...
                level = GetSlotSpellLevel((ObjAIBase)owner, 0, SpellbookType.SPELLBOOK_CHAMPION, SpellSlotType.SpellSlots);
                SpellEffectCreate(out arr, out _, "cryo_FlashFrost_tar.troy", default, teamOfOwner, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, missileEndPosition, target, default, default, true);
