...
namespace Buffs
{
    public class CannonBarrageAoE : BBBuffScript
    {
        float damagePerTick;
        Particle particle;
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle, out _, default, default, default, default, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target);
        }
        ...
        public override void OnUpdateActions()
        {
            if(ExecutePeriodically(1, ref this.lastTimeExecuted, true))
            {
                foreach(AttackableUnit unit in GetUnitsInArea(attacker, owner.Position, 225, SpellDataFlags.AffectEnemies | SpellDataFlags.AffectNeutral | SpellDataFlags.AffectMinions | SpellDataFlags.AffectHeroes))
                {
                    ...
                    SpellEffectCreate(out hi1, out _, default, default, default, default, 0, TeamId.TEAM_UNKNOWN, default, owner, false, unit, "L_foot", default, unit);
                    SpellEffectCreate(out hi2, out _, default, default, default, default, 0, TeamId.TEAM_UNKNOWN, default, owner, false, unit, "R_foot", default, unit);
                }
            }
        }
    }
