...
namespace Buffs
{
    public class NocturneUnspeakableHorror : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            if(nocturneSkinID == 1)
            {
                SpellEffectCreate(out this.targetParticle, out _, "NocturneUnspeakableHorror_tar_frost.troy", default, teamOfAttacker ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "head", default, owner, default, default, false, false, false, false, false);
                SpellEffectCreate(out this.counterParticle, out _, "NocturneUnspeakableHorror_counter_frost.troy", default, teamOfAttacker ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, false, false, false, false, false);
            }
            else if(nocturneSkinID == 4)
            {
                SpellEffectCreate(out this.targetParticle, out _, "NocturneUnspeakableHorror_tar_ghost.troy", default, teamOfAttacker ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "head", default, owner, default, default, false, false, false, false, false);
                SpellEffectCreate(out this.counterParticle, out _, "NocturneUnspeakableHorror_counter_ghost.troy", default, teamOfAttacker ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, false, false, false, false, false);
            }
            else
            {
                SpellEffectCreate(out this.targetParticle, out _, "NocturneUnspeakableHorror_tar.troy", default, teamOfAttacker ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "head", default, owner, default, default, false, false, false, false, false);
                SpellEffectCreate(out this.counterParticle, out _, "NocturneUnspeakableHorror_counter.troy", default, teamOfAttacker ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, false, false, false, false, false);
            }
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            if(!this.feared)
            {
                ...
                SpellEffectCreate(out asdf, out _, "NocturneUnspeakableHorror_break.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "root", default, owner, default, default, true, false, false, false, false);
            }
            else
            {
        ...
        public override void OnUpdateActions()
        {
            ...
            if(ExecutePeriodically(2, ref this.lastTimeExecuted4, false))
            {
                ...
                SpellEffectCreate(out asdf, out _, "NocturneUnspeakableHorror_fear.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "root", default, owner, default, default, true, false, false, false, false);
