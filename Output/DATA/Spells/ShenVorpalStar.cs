...
namespace Buffs
{
    public class ShenVorpalStar : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.slow, out _, "shen_life_tap_tar_02.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, default, default, false, false);
        }
...
namespace Spells
{
    public class ShenVorpalStar : BBSpellScript
    {
        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            SpellEffectCreate(out hit, out _, "shen_vorpalStar_tar.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true, default, default, false, false);
        }
    }
}