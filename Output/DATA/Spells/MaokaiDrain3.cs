...
namespace Buffs
{
    public class MaokaiDrain3 : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle, out _, "maoki_torrent_cas_01.troy", default, teamOfOwner, 10, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, default, targetPos, target, default, default, true, false, false, false, false);
            if(ownerSkinID == 3)
            {
                SpellEffectCreate(out this.particle2, out this.particle3, "maoki_torrent_01_teamID_Christmas_green.troy", "maoki_torrent_01_teamID_Christmas_red.troy", teamOfOwner, 300, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, default, targetPos, target, default, default, false, false, false, false, false);
            }
            else
            {
                SpellEffectCreate(out this.particle2, out this.particle3, "maoki_torrent_01_teamID_green.troy", "maoki_torrent_01_teamID_red.troy", teamOfOwner, 300, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, default, targetPos, target, default, default, false, false, false, false, false);
            }
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            if(charVars.Tally >= 0)
            {
                ...
                SpellEffectCreate(out explosionVFX, out _, "maoki_torrent_deflect_self_cas.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, this.targetPos, owner, default, default, true, false, false, false, false);
                SpellEffectCreate(out explosionVFX, out _, "maoki_torrent_deflect_cas_02.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, this.targetPos, owner, default, default, true, false, false, false, false);
                foreach(AttackableUnit unit in GetUnitsInArea(attacker, this.targetPos, 550, SpellDataFlags.AffectEnemies | SpellDataFlags.AffectNeutral | SpellDataFlags.AffectMinions | SpellDataFlags.AffectHeroes, default, true))
                {
                    ...
                    SpellEffectCreate(out targetVFX, out _, "maoki_torrent_unit_tar.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, unit, default, default, unit, default, default, true, false, false, false, false);
                }
                charVars.Tally = 0;
            }
        }
