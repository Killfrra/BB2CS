...
namespace Spells
{
    public class AhriFoxFire : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            SpellEffectCreate(out varA, out _, "Ahri_FoxFire_cas.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out varA, out _, "Ahri_FoxFire_weapon_cas.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, "BUFFBONE_GLB_WEAPON_1", default, target, "BUFFBONE_GLB_WEAPON_1", default, true, false, false, false, false);
