...
namespace Buffs
{
    public class Gate : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle3, out this.particle4, "CardmasterTeleport_green.troy", "CardmasterTeleport_red.troy", teamOfOwner, 200, 0, TeamId.TEAM_UNKNOWN, default, default, false, owner, default, default, target, default, default, false, default, default, false, false);
...
namespace Spells
{
    public class Gate : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            {
                teamOfOwner = GetTeamID(owner);
                SpellEffectCreate(out this.gateParticle, out this.gateParticle2, "GateMarker_green.troy", "GateMarker_red.troy", teamOfOwner, 200, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, default, targetPos, target, default, default, false, default, default, false, false);
