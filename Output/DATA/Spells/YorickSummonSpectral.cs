...
namespace Buffs
{
    public class YorickSummonSpectral : BBBuffScript
    {
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            SpellEffectCreate(out a, out _, "yorick_spectralGhoul_death.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, ghoulPosition, owner, default, ghoulPosition, true, default, default, false, false);
...
namespace Spells
{
    public class YorickSummonSpectral : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            teamID = GetTeamID(owner);
            other1 = SpawnMinion("Clyde", "YorickSpectralGhoul", "YorickPHPet.lua", targetPos, teamID, false, false, true, false, false, false, 0, false, false, (Champion)owner);
