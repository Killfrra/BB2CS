...
namespace Buffs
{
    public class PoppyHeroicCharge : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particleCharge, out _, "HeroicCharge_cas.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, false, false, false, false);
        ...
        public override void OnMoveSuccess()
        {
            ...
            else
            {
                ...
                float nextBuffVars_DamageTwo;
                SpellEffectCreate(out targetParticle, out _, "HeroicCharge_tar.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, false, false, false, false);
                BreakSpellShields(caster);
