...
namespace Spells
{
    public class GravesSmokeGrenadeBoom : BBSpellScript
    {
        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            SpellEffectCreate(out particle, out _, "Graves_SmokeGrenade_Boom.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, default, targetPos, default, default, targetPos, true, false, false, false, false);
            ...
            other3 = SpawnMinion("HiddenMinion", "TestCube", "idle.lua", targetPos, teamID ?? TeamId.TEAM_CASTER, false, true, false, true, true, true, 50, false, true, (Champion)owner);
