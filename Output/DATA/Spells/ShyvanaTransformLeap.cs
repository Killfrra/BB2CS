...
namespace Buffs
{
    public class ShyvanaTransformLeap : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.selfParticle, out _, "shyvana_R_fire_skin.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out this.selfParticle2, out _, "shyvana_ult_cast_02.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "head", default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out this.selfParticle11, out _, "shyvana_ult_cast_02_firefill.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "l_forearm", default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out this.selfParticle12, out _, "shyvana_ult_cast_02_firefill.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "r_forearm", default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out this.selfParticle3, out _, "shyvana_ult_cast_02.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "spine", default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out this.selfParticle4, out _, "shyvana_ult_cast_02.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "l_shoulder", default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out this.selfParticle5, out _, "shyvana_ult_cast_02.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "r_shoulder", default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out this.selfParticle6, out _, "shyvana_ult_cast_02_arm.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "l_forearm", default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out this.selfParticle7, out _, "shyvana_ult_cast_02_arm.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "r_forearm", default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out this.selfParticle8, out _, "shyvana_ult_cast_02_tail.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "Tail_g", default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out this.selfParticle9, out _, "shyvana_ult_cast_02_hand.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "l_hand", default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out this.selfParticle10, out _, "shyvana_ult_cast_02_hand.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "r_hand", default, target, default, default, true, false, false, false, false);
            this.doOnce = 0;
        }
        ...
        public override void OnUpdateActions()
        {
            ...
            float nextBuffVars_IdealDistance;
            int level;
        ...
        public override void OnMoveSuccess()
        {
            ...
            teamID = GetTeamID(owner);
            SpellEffectCreate(out groundhit, out _, "shyvana_ult_impact_01.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "weapon_C", default, target, default, default, true, false, false, false, false);
