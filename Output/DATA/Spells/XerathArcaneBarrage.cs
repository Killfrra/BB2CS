...
namespace Spells
{
    public class XerathArcaneBarrage : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            Particle a; // UNUSED
            Minion other3;
            float nextBuffVars_SlowAmount; // UNUSED
            int nextBuffVars_DamageAmount; // UNUSED
            ...
            other3 = SpawnMinion("HiddenMinion", "XerathArcaneBarrageLauncher", "idle.lua", targetPos, teamOfOwner ?? TeamId.TEAM_CASTER, false, true, false, true, true, true, 0, false, false, (Champion)owner);
...
namespace Buffs
{
    public class XerathArcaneBarrage : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle1, out this.particle, "Xerath_E_cas_green.troy", "Xerath_E_cas_red.troy", teamID ?? TeamId.TEAM_UNKNOWN, 200, 0, TeamId.TEAM_UNKNOWN, default, default, false, owner, default, default, target, default, default, true, false, false, false, false);
