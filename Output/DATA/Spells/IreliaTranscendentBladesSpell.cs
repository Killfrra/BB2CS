...
namespace Spells
{
    public class IreliaTranscendentBladesSpell : BBSpellScript
    {
        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            SpellEffectCreate(out a, out _, "irelia_ult_tar.troy", default, ireliaTeamID, 10, 0, TeamId.TEAM_UNKNOWN, default, target, false, target, "root", default, target, default, default, true, default, default, false, false);
