...
namespace Buffs
{
    public class AbsoluteZero : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle, out this.particle2, "AbsoluteZero2_green_cas.troy", "AbsoluteZero2_red_cas.troy", teamOfOwner, 10, 0, TeamId.TEAM_PURPLE, default, default, false, owner, default, default, target, default, default, false, default, default, false, false);
...
namespace Spells
{
    public class AbsoluteZero : BBSpellScript
    {
        ...
        public override void ChannelingSuccessStop()
        {
            ...
            SpellEffectCreate(out asdf, out _, "AbsoluteZero_nova.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, attacker, default, default, attacker, default, default, true, default, default, false, false);
            ...
            {
                SpellEffectCreate(out asdf, out _, "AbsoluteZero_tar.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, unit, default, default, unit, default, default, true, default, default, false, false);
