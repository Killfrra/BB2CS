...
namespace Spells
{
    public class YorickDeathGrip : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            other1 = SpawnMinion("hiu", "TestCubeRender", "idle.lua", firstPos, teamID, false, true, false, false, false, true, 300, default, true, (Champion)owner);
            ...
            other2 = SpawnMinion("hiu", "TestCubeRender", "idle.lua", lastPos, teamID, false, true, false, false, false, true, 300, default, true, (Champion)owner);
            ...
            other3 = SpawnMinion("hiu", "TestCubeRender", "idle.lua", targetPos, teamID, false, true, false, false, false, true, 300 + lineWidth, default, true, (Champion)owner);
