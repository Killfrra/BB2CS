    ...
    public class CassiopeiaTwinFang : BBSpellScript
    {
        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            if(HasBuffOfType(target, BuffType.POISON))
            {
                ...
                SpellEffectCreate(out particle, out _, "CassioTwinFang_refreshsound.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, true);
            }
