...
namespace Spells
{
    public class MegaAdhesive : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            other2 = SpawnMinion("k", "SpellBook1", "idle.lua", castPos, teamID ?? TeamId.TEAM_NEUTRAL, true, true, false, false, true, false, 0, default, true);
...
namespace Buffs
{
    public class MegaAdhesive : BBBuffScript
    {
        ...
        {
            float nextBuffVars_Duration; // UNUSED
            float nextBuffVars_SlowPercent;
