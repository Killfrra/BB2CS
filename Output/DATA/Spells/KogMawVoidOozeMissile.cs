...
namespace Buffs
{
    public class KogMawVoidOozeMissile : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle, out this.particle2, "KogMawVoidOoze_green.troy", "KogMawVoidOoze_red.troy", teamOfOwner, 240, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, default, targetPos, target, default, default, false, default, default, true, false);
        }
    ...
    public class KogMawVoidOozeMissile : BBSpellScript
    {
        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            if(owner.Team != target.Team)
            {
                ...
                SpellEffectCreate(out varrr, out _, "KogMawVoidOoze_tar.troy", default, casterID2, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true, default, default, false, false);
            }
        }
    }
}