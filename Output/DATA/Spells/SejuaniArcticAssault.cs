...
namespace Spells
{
    public class SejuaniArcticAssault : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            int nextBuffVars_Defenses; // UNUSED
            ...
            SpellEffectCreate(out _, out _, "sejuani_arctic_assault_cas_02.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true, false, false, false, false);
        }
    }
}
namespace Buffs
{
    public class SejuaniArcticAssault : BBBuffScript
    {
                        ...
                        if(GetBuffCountFromCaster(target, default, nameof(Buffs.SharedWardBuff)) == 0)
                        {
                            ...
                            else if(target is not BaseTurret)
                            {
                                if(GetBuffCountFromCaster(target, owner, nameof(Buffs.SejuaniArcticAssaultMarker)) == 0)
                                {
                                    ...
                                    SpellEffectCreate(out asdf1, out _, "sejuani_arctic_assault_unit_tar_02.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 10, TeamId.TEAM_UNKNOWN, default, owner, false, target, "C_BUFFBONE_GLB_CHEST_LOC", default, target, default, default, true, false, false, false, false);
                                    SpellEffectCreate(out asdf2, out _, "sejuani_arctic_assault_unit_tar.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 10, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true, false, false, false, false);
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.a, out _, "sejuani_arctic_assault_cas_04.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, false, false, false, false);
                ...
                if(GetBuffCountFromCaster(unit, default, nameof(Buffs.SharedWardBuff)) == 0)
                {
                    ...
                    else if(unit is not BaseTurret)
                    {
                        if(GetBuffCountFromCaster(unit, owner, nameof(Buffs.SejuaniArcticAssaultMarker)) == 0)
                        {
                            ...
                            SpellEffectCreate(out asdf1, out _, "sejuani_arctic_assault_unit_tar_02.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 10, TeamId.TEAM_UNKNOWN, default, owner, false, unit, "C_BUFFBONE_GLB_CHEST_LOC", default, unit, default, default, true, false, false, false, false);
                            SpellEffectCreate(out asdf2, out _, "sejuani_arctic_assault_unit_tar.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 10, TeamId.TEAM_UNKNOWN, default, owner, false, unit, default, default, unit, default, default, true, false, false, false, false);
        ...
        public override void OnMoveEnd()
        {
            ...
            UnlockAnimation(owner, true);
            level = GetSlotSpellLevel((ObjAIBase)owner, 0, SpellbookType.SPELLBOOK_CHAMPION, SpellSlotType.SpellSlots);
            SpellEffectCreate(out hi, out _, "sejuani_arctic_assault_cas_03.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out this.partname, out _, "Sejuani_ArcticAssault_Impact.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 300, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, owner.Position, target, default, default, true, false, false, false, false);
