...
namespace Buffs
{
    public class Empower : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle, out _, "Empower_buf.troy", default, TeamId.TEAM_UNKNOWN, 0, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "weaponstreak", default, owner, default, default, false, default, default, false);
        ...
        public override void OnHitUnit(float damageAmount, DamageType damageType, DamageSource damageSource, HitResult hitResult)
        {
            ...
            float aoEDamage;
            SpellEffectCreate(out part, out _, "TiamatMelee_itm.troy", default, TeamId.TEAM_UNKNOWN, 0, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, false, default, default, false);
            ...
            SpellBuffRemoveStacks(owner, owner, nameof(Buffs.EmpowerCleave), 0);
        }
    }
}
namespace Spells
{
    public class Empower : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            AddBuff((ObjAIBase)owner, owner, new Buffs.Empower(nextBuffVars_DamagePerStack), 1, 1, 8, BuffAddType.RENEW_EXISTING, BuffType.INTERNAL, 0, true, false, false);
        }
    }
}