...
namespace Spells
{
    public class VolibearE : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            int nextBuffVars_VolibearEExtender;
            float damageToDeal;
            Particle targetParticle; // UNUSED
            teamID = GetTeamID(owner);
            SpellEffectCreate(out this.partname, out _, "volibear_E_aoe_indicator.troy", default, teamID, 350, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, owner.Position, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out this.partname, out _, "volibear_E_aoe_indicator_02.troy", default, teamID, 350, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, owner.Position, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out _, out _, "Volibear_E_cas_blast.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, owner.Position, default, default, default, true, false, false, false, false);
            SpellEffectCreate(out _, out _, "Volibear_E_cas.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, owner.Position, default, default, default, true, false, false, false, false);
            ...
            {
                SpellEffectCreate(out targetParticle, out _, "volibear_E_tar.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, unit, default, default, unit, default, default, true, false, false, false, false);
