...
namespace Buffs
{
    public class OrianaIzunaDamage : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out temp, out _, "OrianaIzuna_tar.troy", default, casterTeam, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, true, default, default, false, false);
