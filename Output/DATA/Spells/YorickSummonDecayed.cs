...
namespace Buffs
{
    public class YorickSummonDecayed : BBBuffScript
    {
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            SpellEffectCreate(out b, out _, "yorick_necroExplosion_deactivate.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, ghoulPosition, owner, default, default, true, default, default, false, false);
...
namespace Spells
{
    public class YorickSummonDecayed : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            teamID = GetTeamID(owner);
            other1 = SpawnMinion("Inky", "YorickDecayedGhoul", "YorickPHPet.lua", targetPos, teamID, false, false, true, false, false, false, 0, false, false, (Champion)owner);
