...
namespace Buffs
{
    public class MegaAdhesiveApplicator : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle2, out this.particle, "MegaAdhesive_green_pool.troy", "MegaAdhesive_red_pool.troy", teamOfOwner, 500, 0, TeamId.TEAM_UNKNOWN, default, default, false, owner, default, default, target, default, default, false, default, default, false, false);
        }
