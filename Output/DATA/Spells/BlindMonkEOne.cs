    ...
    public class BlindMonkEOne : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            foreach(AttackableUnit unit in GetUnitsInArea((ObjAIBase)owner, owner.Position, 450, SpellDataFlags.AffectEnemies | SpellDataFlags.AffectNeutral | SpellDataFlags.AffectMinions | SpellDataFlags.AffectHeroes, nameof(Buffs.SharedWardBuff), false))
            {
                ...
                SpellEffectCreate(out aoehit, out _, "blindMonk_thunderCrash_impact_unit_tar.troy", default, casterID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, unit, default, default, unit, default, default, true, default, default, false, false);
                SpellEffectCreate(out aoehit, out _, "blindMonk_E_thunderCrash_tar.troy", default, casterID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, unit, default, default, unit, default, default, true, default, default, false, false);
                SpellEffectCreate(out aoehit, out _, "blindMonk_E_thunderCrash_unit_tar_blood.troy", default, casterID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, unit, default, default, unit, default, default, true, default, default, false, false);
                hasHitTarget = true;
            }
            if(hasHitTarget)
            {
