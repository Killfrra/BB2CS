    ...
    public class Frostbite : BBSpellScript
    {
        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            if(count > 0)
            {
                ...
                SpellEffectCreate(out smokeBomb, out _, "cryo_FrostBite_chilled_tar.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true);
            }
            else
            {
