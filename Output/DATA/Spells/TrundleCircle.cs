    ...
    public class TrundleCircle : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            else
            {
                ...
                TeamId teamID;
                Minion other3;
                int nextBuffVars_ID; // UNUSED
                level = GetSlotSpellLevel((ObjAIBase)owner, 2, SpellbookType.SPELLBOOK_CHAMPION, SpellSlotType.SpellSlots);
                targetPos = GetCastSpellTargetPos();
                teamID = GetTeamID(owner);
                other3 = SpawnMinion("PlagueBlock", "TrundleWall", "idle.lua", targetPos, teamID ?? TeamId.TEAM_UNKNOWN, true, true, true, true, false, true, 0, false, false);
                nextBuffVars_ID = 1;
...
namespace Buffs
{
    public class TrundleCircle : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle, out this.particle2, "trundle_PlagueBlock_green.troy", "trundle_PlagueBlock_red.troy", teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_BLUE, default, default, false, owner, default, default, owner, default, default, false, false, false, false, false);
            //RequireVar(this.iD);
