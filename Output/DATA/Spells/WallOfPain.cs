...
namespace Spells
{
    public class WallOfPain : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            other1 = SpawnMinion("hiu", "TestCubeRender", "idle.lua", firstPos, teamID ?? TeamId.TEAM_CASTER, false, true, false, false, false, true, 300, false, true, (Champion)owner);
            AddBuff(other1, other1, new Buffs.ExpirationTimer(), 1, 1, 5, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
            other2 = SpawnMinion("hiu", "TestCubeRender", "idle.lua", lastPos, teamID ?? TeamId.TEAM_CASTER, false, true, false, false, false, true, 300, false, true, (Champion)owner);
            ...
            other3 = SpawnMinion("hiu", "TestCubeRender", "idle.lua", targetPos, teamID ?? TeamId.TEAM_CASTER, false, true, false, false, false, true, 300 + lineWidth, false, true, (Champion)owner);
