...
namespace Buffs
{
    public class Shatter : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out shatterz, out _, "Shatter_tar.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out shatterz, out _, "BloodSlash.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, false, false, false, false);
        }
...
namespace Spells
{
    public class Shatter : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            Particle hi; // UNUSED
            teamID = GetTeamID(owner);
            SpellEffectCreate(out hi, out _, "Shatter_nova.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, true, false, false, false, false);
