...
namespace Spells
{
    public class TrundleDesecrate : BBSpellScript
    {
        public override void SelfExecute()
        {
            ...
            other1 = SpawnMinion("birds", "TestCube", "idle.lua", ownerPos, teamID ?? TeamId.TEAM_UNKNOWN, true, true, true, true, true, true, 0, false, true);
...
namespace Buffs
{
    public class TrundleDesecrate : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle2, out this.particle, "trundledesecrate_green.troy", "trundledesecrate_red.troy", teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_BLUE, default, default, false, owner, default, default, owner, default, default, false, default, default, false, false);
