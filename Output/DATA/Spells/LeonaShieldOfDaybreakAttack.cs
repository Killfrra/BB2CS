    ...
    public class LeonaShieldOfDaybreakAttack : BBSpellScript
    {
        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            if(target is ObjAIBase)
            {
                ...
                SpellEffectCreate(out temp, out _, "Leona_ShieldOfDaybreak_nova.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, targetPos, target, default, default, true, default, default, false, false);
                SpellEffectCreate(out temp, out _, "Leona_ShieldOfDaybreak_tar.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true, default, default, false, false);
