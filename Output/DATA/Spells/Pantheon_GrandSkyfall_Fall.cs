...
namespace Buffs
{
    public class Pantheon_GrandSkyfall_Fall : BBBuffScript
    {
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            SpellEffectCreate(out a, out _, "pantheon_grandskyfall_land.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, target, false, default, default, targetPos, target, default, targetPos, true, default, default, false, false);
