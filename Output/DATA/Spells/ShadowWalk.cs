    ...
    public class ShadowWalk : BBSpellScript
    {
        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            else
            {
                ...
                SpellEffectCreate(out particle, out _, "evelyn_invis_cas.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, default, default, false, false);
...
namespace Buffs
{
    public class ShadowWalk : BBBuffScript
    {
        ...
        {
            float nextBuffVars_MoveSpeedMod;
            TeamId nextBuffVars_TeamID; // UNUSED
