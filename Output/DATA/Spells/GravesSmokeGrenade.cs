...
namespace Spells
{
    public class GravesSmokeGrenade : BBSpellScript
    {
        public override void SelfExecute()
        {
            ...
            other2 = SpawnMinion("k", "TestCubeRender10Vision", "idle.lua", targetPos, teamID ?? TeamId.TEAM_NEUTRAL, true, true, false, true, true, true, 50, false, true, (Champion)attacker);
...
namespace Buffs
{
    public class GravesSmokeGrenade : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle2, out this.particle, "Graves_SmokeGrenade_Cloud_Team_Green.troy", "Graves_SmokeGrenade_Cloud_Team_Red.troy", casterID ?? TeamId.TEAM_UNKNOWN, 250, 0, TeamId.TEAM_BLUE, default, owner, false, owner, default, default, owner, default, default, false, false, false, false, false);
