...
namespace Buffs
{
    public class XenZhaoBattleCry : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.battleCryPH, out _, "xen_ziou_battleCry_cas_05.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, false, default, default, false);
            SpellEffectCreate(out this.battleCryPH, out _, "xen_ziou_battleCry_cas_03.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "BUFFBONE_CSTM_WEAPON_1", default, owner, default, default, false, default, default, false);
            SpellEffectCreate(out this.battleCryPH, out _, "xen_ziou_battleCry_cas_02.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "R_BUFFBONE_GLB_HAND_LOC", default, owner, default, default, true, default, default, false);
            SpellEffectCreate(out this.battleCryPH, out _, "xenZhiou_battleCry_active.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "R_BUFFBONE_GLB_HAND_LOC", default, owner, default, default, false, default, default, false);
            SpellEffectCreate(out this.battleCryPH, out _, "xenZhiou_battleCry_active.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "L_BUFFBONE_GLB_HAND_LOC", default, owner, default, default, false, default, default, false);
            SpellEffectCreate(out this.battleCries, out _, "xenZiou_battle_cry_weapon_01.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "BUFFBONE_CSTM_WEAPON_1", default, owner, "BUFFBONE_CSTM_WEAPON_4", default, false, default, default, false);
        }
