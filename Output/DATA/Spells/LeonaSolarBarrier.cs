...
namespace Buffs
{
    public class LeonaSolarBarrier : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle, out _, "Leona_SolarBarrier_buf.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, true, default, default, false, false);
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            if(!owner.IsDead)
            {
                ...
                foreach(AttackableUnit unit in GetUnitsInArea((ObjAIBase)owner, owner.Position, 450, SpellDataFlags.AffectEnemies | SpellDataFlags.AffectNeutral | SpellDataFlags.AffectMinions | SpellDataFlags.AffectHeroes, default, true))
                {
                    ...
                    SpellEffectCreate(out targetParticle, out _, "Leona_SolarBarrier_tar.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, unit, default, default, unit, default, default, true, default, default, false, false);
                }
                ...
                if(targetStruck)
                {
                    SpellEffectCreate(out temp, out _, "Leona_SolarBarrier_nova.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, owner.Position, target, default, default, true, default, default, false, false);
                ...
                {
                    SpellEffectCreate(out temp, out _, "Leona_SolarBarrier_nova_whiff.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, owner.Position, target, default, default, true, default, default, false, false);
                }
            }
        }
