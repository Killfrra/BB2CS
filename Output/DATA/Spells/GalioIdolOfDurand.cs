...
namespace Buffs
{
    public class GalioIdolOfDurand : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.areaVFXAlly, out this.areaVFXEnemy, "galio_beguilingStatue_taunt_indicator_team_green.troy", "galio_beguilingStatue_taunt_indicator_team_red.troy", teamID ?? TeamId.TEAM_UNKNOWN, 0, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, false, default, default, false, false);
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            SpellEffectCreate(out explosionVFX, out _, "galio_talion_breakout.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, false, default, default, false, false);
            SpellEffectCreate(out explosionVFX, out _, "galio_builingStatue_impact_01.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, false, default, default, false, false);
            ...
            foreach(AttackableUnit unit in GetUnitsInArea((ObjAIBase)owner, owner.Position, 575, SpellDataFlags.AffectEnemies | SpellDataFlags.AffectNeutral | SpellDataFlags.AffectMinions | SpellDataFlags.AffectHeroes, default, true))
            {
                ...
                SpellEffectCreate(out targetVFX, out _, "galio_builingStatue_unit_impact_01.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, unit, default, default, unit, default, default, false, default, default, false, false);
            }
        }
