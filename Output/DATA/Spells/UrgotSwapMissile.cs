    ...
    public class UrgotSwapMissile : BBBuffScript
    {
        ...
        public override void OnUpdateActions()
        {
            if(ExecutePeriodically(0.1f, ref this.lastTimeExecuted, true))
            {
                ...
                other2 = SpawnMinion("enemy", "TestCubeRender", "idle.lua", targetPos, teamID ?? TeamId.TEAM_NEUTRAL, true, true, false, true, true, true, 0, default, true);
                ...
                other3 = SpawnMinion("ownerMinion", "TestCubeRender", "idle.lua", ownerPos, teamID ?? TeamId.TEAM_NEUTRAL, true, true, false, true, true, true, 0, default, true);
