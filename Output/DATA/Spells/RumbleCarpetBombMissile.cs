...
namespace Spells
{
    public class RumbleCarpetBombMissile : BBSpellScript
    {
        ...
        public override void OnMissileUpdate(SpellMissile missileNetworkID, Vector3 missilePosition)
        {
            ...
            SpellEffectCreate(out this.particle, out _, "rumble_ult_placeholder_01.troy", default, teamOfOwner, 200, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, default, missilePosition, target, default, default, true, default, default, false, false);
            if(rumbleSkinID == 2)
            {
                SpellEffectCreate(out this.particle1, out _, "rumble_incoming_mis_cannon_ball.troy", default, teamOfOwner, 200, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, default, missilePosition, target, default, default, true, default, default, false, false);
            }
            else if(rumbleSkinID == 1)
            {
                SpellEffectCreate(out this.particle1, out _, "rumble_incoming_mis_pineapple.troy", default, teamOfOwner, 200, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, default, missilePosition, target, default, default, true, default, default, false, false);
            }
            else
            {
                SpellEffectCreate(out this.particle1, out _, "rumble_incoming_mis.troy", default, teamOfOwner, 200, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, default, missilePosition, target, default, default, true, default, default, false, false);
            }
