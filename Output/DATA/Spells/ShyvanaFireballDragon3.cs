...
namespace Spells
{
    public class ShyvanaFireballDragon3 : BBSpellScript
    {
        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            SpellEffectCreate(out a, out _, "Incinerate_buf.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true, false, false, false, false);
        ...
        public override void SelfExecute()
        {
            ...
            other1 = SpawnMinion("ConeBreathMarker", "TestCubeRender10Vision", "idle.lua", pointToSpawn, teamID, false, true, false, false, false, true, 1, false, false, (Champion)owner);
