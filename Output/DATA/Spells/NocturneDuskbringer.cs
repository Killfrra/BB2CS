...
namespace Spells
{
    public class NocturneDuskbringer : BBSpellScript
    {
        ...
        public override void OnMissileUpdate(SpellMissile missileNetworkID, Vector3 missilePosition)
        {
            ...
            other3 = SpawnMinion("DarkPath", "testcube", "idle.lua", groundHeight, teamID ?? TeamId.TEAM_CASTER, true, true, true, true, false, true, 0, false, true);
        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            if(target == owner)
            {
                ...
                other3 = SpawnMinion("DarkPath", "testcube", "idle.lua", myPosition, teamID ?? TeamId.TEAM_CASTER, true, true, true, true, false, true, 0, false, true);
                targetPos = GetCastSpellTargetPos();
                FaceDirection(other3, targetPos);
                AddBuff((ObjAIBase)owner, other3, new Buffs.NocturneDuskbringer(nextBuffVars_HastePercent, nextBuffVars_BonusAD), 1, 1, 4, BuffAddType.RENEW_EXISTING, BuffType.INTERNAL, 0, true, false, false);
            }
            else
            {
                ...
                if(!isStealthed)
                {
                    if(target is Champion)
                    {
                        ...
                        SpellEffectCreate(out targettrail, out _, "NocturneDuskbringer_tar.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, default, false, target, default, default, target, default, default, true, false, false, false, false);
                        ...
                        if(nocturneSkinID == 1)
                        {
                            SpellEffectCreate(out targettrail, out _, "NocturneDuskbringer_frost_buf.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, default, false, target, default, default, target, default, default, false, false, false, false, false);
                        }
                        else
                        {
                            SpellEffectCreate(out targettrail, out _, "NocturneDuskbringer_buf.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, default, false, target, default, default, target, default, default, false, false, false, false, false);
                        }
                    }
                    else
                    {
...
namespace Buffs
{
    public class NocturneDuskbringer : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            if(nocturneSkinID == 1)
            {
                SpellEffectCreate(out this.particle2, out this.particle, "NocturneDuskbringer_path_frost_green.troy", "NocturneDuskbringer_path_frost_red.troy", teamOfOwner ?? TeamId.TEAM_UNKNOWN, 240, 0, TeamId.TEAM_UNKNOWN, default, default, false, owner, default, default, target, default, default, false, false, false, true, false, orientationPoint);
            }
            else if(nocturneSkinID == 4)
            {
                SpellEffectCreate(out this.particle2, out this.particle, "NocturneDuskbringer_path_ghost_green.troy", "NocturneDuskbringer_path_ghost_red.troy", teamOfOwner ?? TeamId.TEAM_UNKNOWN, 240, 0, TeamId.TEAM_UNKNOWN, default, default, false, owner, default, default, target, default, default, false, false, false, true, false, orientationPoint);
            }
            else
            {
                SpellEffectCreate(out this.particle2, out this.particle, "NocturneDuskbringer_path_green.troy", "NocturneDuskbringer_path_red.troy", teamOfOwner ?? TeamId.TEAM_UNKNOWN, 240, 0, TeamId.TEAM_UNKNOWN, default, default, false, owner, default, default, target, default, default, false, false, false, true, false, orientationPoint);
            }
            SetTargetable(owner, false);
