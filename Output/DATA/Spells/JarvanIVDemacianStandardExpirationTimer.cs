...
namespace Buffs
{
    public class JarvanIVDemacianStandardExpirationTimer : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle, out this.particle1, "olaf_axe_totem_team_id_green.troy", "olaf_axe_totem_team_id_red.troy", teamOfOwner, 400, 0, TeamId.TEAM_UNKNOWN, default, default, false, owner, default, default, target, default, default, false, default, default, false, false);
        }
        ...
        public override void OnUpdateActions()
        {
            ...
            foreach(AttackableUnit unit in GetUnitsInArea((ObjAIBase)owner, owner.Position, 250, SpellDataFlags.AffectEnemies | SpellDataFlags.AffectFriends | SpellDataFlags.AffectNeutral | SpellDataFlags.AffectHeroes, nameof(Buffs.OlafBerzerkerRage), true))
            {
                if(unit == attacker)
                {
                    ...
                    SpellEffectCreate(out b, out _, "olaf_axe_trigger_02.troy", default, teamID, 100, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, ownerPos, target, default, default, true, default, default, false, false);
