...
namespace Spells
{
    public class VolibearW : BBSpellScript
    {
        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            debuffFound = false;
            teamID = GetTeamID(owner);
            SpellEffectCreate(out part1, out part2, "VolibearW_tar.troy", "VolibearW_tar.troy", teamID, 10, 0, TeamId.TEAM_UNKNOWN, teamID, owner, false, target, default, default, target, default, default, true, false, false, false, false);
