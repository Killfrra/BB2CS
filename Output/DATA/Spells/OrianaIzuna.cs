        ...
        public override void OnMissileEnd(string spellName, Vector3 missileEndPosition)
        {
            ...
            if(duration >= 0.001f)
            {
                if(correctSpell)
                {
                    ...
                    other3 = SpawnMinion("TheDoomBall", "OriannaBall", "idle.lua", missileEndPosition, teamID ?? TeamId.TEAM_BLUE, false, true, false, true, true, true, 0, false, true, (Champion)owner);
                    level = GetSlotSpellLevel((ObjAIBase)owner, 0, SpellbookType.SPELLBOOK_CHAMPION, SpellSlotType.SpellSlots);
                    SpellEffectCreate(out temp, out _, "Oriana_Izuna_nova.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, missileEndPosition, default, default, missileEndPosition, true, default, default, false, false);
