    ...
    public class LuxIlluminationPassive : BBBuffScript
    {
        ...
        public override void OnHitUnit(float damageAmount, DamageType damageType, DamageSource damageSource, HitResult hitResult)
        {
            ...
            if(GetBuffCountFromCaster(target, attacker, nameof(Buffs.LuxIlluminatingFraulein)) > 0)
            {
                ...
                SpellEffectCreate(out motaExplosion, out _, "LuxPassive_tar.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true, default, default, false, false);
