...
namespace Spells
{
    public class GragasBarrelRoll : BBSpellScript
    {
        ...
        {
            Vector3 targetPos;
            int nextBuffVars_DamageLevel; // UNUSED
    ...
    public class GragasBarrelRoll : BBBuffScript
    {
        ...
        public override void OnMissileEnd(string spellName, Vector3 missileEndPosition)
        {
            if(spellName == nameof(Spells.GragasBarrelRollMissile))
            {
                ...
                other1 = SpawnMinion("DoABarrelRoll", "TestCube", "idle.lua", targetPos, teamID ?? TeamId.TEAM_CASTER, false, true, false, true, true, true, 0, default, true, (Champion)owner);
