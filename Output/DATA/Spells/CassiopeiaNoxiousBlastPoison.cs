...
namespace Buffs
{
    public class CassiopeiaNoxiousBlastPoison : BBBuffScript
    {
        ...
        public override void OnUpdateActions()
        {
            ...
            {
                ApplyDamage(attacker, target, this.damagePerTick, DamageType.DAMAGE_TYPE_MAGICAL, DamageSource.DAMAGE_SOURCE_SPELLAOE, 1, 0.3f, 1, false, false, attacker);
            }
        }
    }
}