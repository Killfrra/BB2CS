...
namespace Spells
{
    public class LeblancSlide : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            SpellEffectCreate(out smokeBomb1, out _, "leBlanc_displacement_cas.troy", default, casterID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, ownerPos, target, default, default, true, default, default, false);
