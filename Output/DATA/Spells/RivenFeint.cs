    ...
    public class RivenFeint : BBBuffScript
    {
        ...
        public override void OnPreDamage(float damageAmount, DamageType damageType, DamageSource damageSource)
        {
            ...
            else
            {
                ...
                this.damageBlock = 0;
                ReduceShield(owner, this.oldArmorAmount, true, true);
                SpellEffectCreate(out ar, out _, "exile_E_interupt.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, false, false, false, false);
