...
namespace Spells
{
    public class MissileBarrageMissile2 : BBSpellScript
    {
        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            if(!isStealthed)
            {
                SpellEffectCreate(out part, out _, "corki_MissleBarrage_DD_tar.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, "spine", target.Position, target, default, default, true, default, default, false, false);
