    ...
    public class KarmaSpiritBond : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            if(this.mantraBoolean == 1)
            {
                ...
                SpellEffectCreate(out this.particleID, out this.soulShackleIdle, "karma_spiritBond_ult_beam_teamID_ally_green.troy", "karma_spiritBond_ult_beam_teamID_enemy_red.troy", teamOfAttacker, 0, 0, TeamId.TEAM_UNKNOWN, default, owner, false, attacker, "root", default, owner, "root", default, false, default, default, false, false);
        ...
        public override void OnUpdateActions()
        {
            ...
            else
            {
                ...
                else
                {
                    if(distance > 900)
                    {
                        SpellEffectCreate(out distanceBreak1, out _, "karma_spiritBond_break_overhead.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, true, default, default, false, false);
                        SpellEffectCreate(out distanceBreak2, out _, "karma_spiritBond_break_overhead.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, attacker, default, default, attacker, default, default, true, default, default, false, false);
                        SpellBuffRemoveCurrent(owner);
                    }
                }
            }
