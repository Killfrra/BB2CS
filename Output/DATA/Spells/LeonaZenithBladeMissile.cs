    ...
    public class LeonaZenithBladeMissile : BBSpellScript
    {
        ...
        public override void OnMissileEnd(string spellName, Vector3 missileEndPosition)
        {
            ...
            foreach(AttackableUnit unit in GetClosestUnitsInArea(owner, owner.Position, 3000, SpellDataFlags.AffectEnemies | SpellDataFlags.AffectNeutral | SpellDataFlags.AffectMinions | SpellDataFlags.AffectHeroes | SpellDataFlags.AffectDead, 1, nameof(Buffs.LeonaZenithBladeBuffOrder), true))
            {
                ...
                SpellEffectCreate(out ar1, out _, "Leona_ZenithBlade_trail.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 225, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, default, default, false, false);
            }
        }
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            if(target is not Champion)
            {
                ...
                SpellEffectCreate(out temp, out _, "Leona_ZenithBlade_sound.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, default, target, default, default, true, default, default, false, false);
            }
        }
    }
}
