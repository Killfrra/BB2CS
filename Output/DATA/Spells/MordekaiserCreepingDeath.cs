    ...
    public class MordekaiserCreepingDeath : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            if(owner != attacker)
            {
                ...
                {
                    SpellEffectCreate(out this.b, out _, "mordekaiser_creepingDeath_auraGold.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, false, false, false, false);
                }
                else if(mordekaiserSkinID == 2)
                {
                    SpellEffectCreate(out this.b, out _, "mordekaiser_creepingDeath_auraRed.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, false, false, false, false);
                }
                else
                {
                    SpellEffectCreate(out this.b, out _, "mordekaiser_creepingDeath_aura.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, false, false, false, false);
                }
            }
            else
            {
                SpellEffectCreate(out this.b, out _, "mordekaiser_creepingDeath_tar.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, false, false, false, false);
            }
        }
