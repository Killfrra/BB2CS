        ...
        public override void OnMissileEnd(string spellName, Vector3 missileEndPosition)
        {
            ...
            if(duration >= 0.001f)
            {
                if(correctSpell)
                {
                    ...
                    other3 = SpawnMinion("HiddenMinion", "TestCube", "idle.lua", missileEndPosition, teamID ?? TeamId.TEAM_BLUE, false, true, false, true, true, true, 0, default, true, (Champion)owner);
