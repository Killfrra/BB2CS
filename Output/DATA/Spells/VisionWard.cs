...
namespace Spells
{
    public class VisionWard : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            other3 = SpawnMinion("VisionWard", "VisionWard", "idle.lua", targetPos, teamID ?? TeamId.TEAM_UNKNOWN, true, true, false, false, false, false, 0, true, false, (Champion)owner);
...
namespace Buffs
{
    public class VisionWard : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            this.bubbleID = AddUnitPerceptionBubble(casterID, 1100, owner, 180, default, default, true);
