...
namespace Buffs
{
    public class SonaHymnofValorSound : BBBuffScript
    {
        ...
        {
            SpellEffectCreate(out this.part2, out _, "SonaHymnofValorSound.troy", default, TeamId.TEAM_UNKNOWN, 0, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, false);
        }
