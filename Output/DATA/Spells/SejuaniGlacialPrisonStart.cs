    ...
    public class SejuaniGlacialPrisonStart : BBBuffScript
    {
        ...
        public override void OnMissileEnd(string spellName, Vector3 missileEndPosition)
        {
            if(spellName == nameof(Spells.SejuaniGlacialPrison))
            {
                ...
                SpellEffectCreate(out particle2, out _, "sejuani_ult_impact_nova.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, missileEndPosition, default, default, default, true, false, false, false, false);
                SpellEffectCreate(out particle3, out _, "sejuani_ult_tar.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, missileEndPosition, default, default, default, true, false, false, false, false);
