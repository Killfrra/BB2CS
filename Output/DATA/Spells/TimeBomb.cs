...
namespace Buffs
{
    public class TimeBomb : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particleID2, out this.particleID, "TimeBomb_green.troy", "TimeBomb_red.troy", teamOfOwner, 500, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, false, default, default, false, false);
            this.tickDamage = 3;
        }
        public override void OnDeactivate(bool expired)
        {
            ...
            if(owner.IsDead)
            {
                ...
                SpellEffectCreate(out par, out _, "TimeBombExplo.troy", default, teamID, 500, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, owner.Position, target, default, default, true, default, default, false, false);
