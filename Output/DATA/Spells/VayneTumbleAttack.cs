...
namespace Spells
{
    public class VayneTumbleAttack : BBSpellScript
    {
        ...
        public override void TargetExecute(SpellMissile missileNetworkID, HitResult hitResult)
        {
            ...
            if(target is ObjAIBase)
            {
                ...
                {
                    Particle hi; // UNUSED
                    SpellEffectCreate(out hi, out _, "vayne_Q_tar.troy", default, TeamId.TEAM_NEUTRAL, 200, 0, TeamId.TEAM_UNKNOWN, default, owner, false, target, default, owner.Position, target, default, default, true, false, false, false, false);
