...
namespace Spells
{
    public class Crowstorm : BBSpellScript
    {
        ...
        public override void ChannelingSuccessStop()
        {
            ...
            castPos = GetCastSpellTargetPos();
            SpellEffectCreate(out p3, out _, "summoner_flashback.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, castPos, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out ar, out _, "summoner_cast.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, owner.Position, target, default, default, true, false, false, false, false);
            SpellEffectCreate(out ar1, out _, "summoner_flash.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, false, false, false, false);
...
namespace Buffs
{
    public class Crowstorm : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle, out this.particle2, "Crowstorm_green_cas.troy", "Crowstorm_red_cas.troy", teamOfOwner ?? TeamId.TEAM_UNKNOWN, 500, 0, TeamId.TEAM_UNKNOWN, default, default, false, owner, default, default, target, default, default, false, false, false, false, false);
        }
