...
namespace Buffs
{
    public class FizzMarinerDoomMissile : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.temp4, out this.temp3, "Fizz_Ring_Green.troy", "Fizz_Ring_Red.troy", teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, "head", groundPos, default, default, this.missilePosition, false, false, false, false, false);
            SpellEffectCreate(out this.temp, out this.temp2, "Fizz_UltimateMissile_Orbit.troy", "Fizz_UltimateMissile_Orbit.troy", teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, "head", groundPos, default, default, this.missilePosition, false, false, false, false, false);
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            if(!this.exploded)
            {
                ...
                other1 = SpawnMinion("OMNOMNOMNOMONOM", "FizzShark", "idle.lua", this.missilePosition, teamID ?? TeamId.TEAM_CASTER, true, true, true, true, true, true, 100, true, false, (Champion)owner);
                groundPos = GetGroundHeight(this.missilePosition);
                SpellEffectCreate(out temp, out temp, "Fizz_SharkSplash.troy", "Fizz_SharkSplash.troy", teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, default, default, groundPos, default, default, groundPos, true, false, false, false, false);
