...
namespace Buffs
{
    public class JarvanIVCataclysmAttack : BBBuffScript
    {
        ...
        public override void OnDeactivate(bool expired)
        {
            ...
            SpellEffectCreate(out asdf, out _, "JarvanWallCrumble.troy", default, teamID, 0, 0, TeamId.TEAM_UNKNOWN, default, default, false, default, "root", ownerPos, owner, default, default, true, false, false, false, false);
