...
namespace Buffs
{
    public class AlZaharCalloftheVoid : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle3, out this.particle2, "voidportal_green.troy", "voidportal_red.troy", teamOfOwner, 200, 0, TeamId.TEAM_UNKNOWN, default, default, false, owner, default, default, target, default, default, true, default, default, false, false);
        }
...
namespace Spells
{
    public class AlZaharCalloftheVoid : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            other1 = SpawnMinion("Portal to the Void", "TestCubeRender", "idle.lua", firstPos, teamID, false, true, false, true, false, true, 300, false, false, (Champion)owner);
            other2 = SpawnMinion("Portal to the Void", "TestCubeRender", "idle.lua", lastPos, teamID, false, true, false, true, false, true, 300 + lineWidth, false, false, (Champion)owner);
