...
namespace Spells
{
    public class UdyrTigerStance : BBSpellScript
    {
        ...
        public override void SelfExecute()
        {
            ...
            SpellEffectCreate(out tigerparticle, out _, "TigerStance.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, default, default, false, false);
...
namespace Buffs
{
    public class UdyrTigerStance : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            teamID = GetTeamID(owner);
            SpellEffectCreate(out this.tiger, out _, "tigerpelt.troy", default, teamID ?? TeamId.TEAM_UNKNOWN, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, "head", default, owner, default, default, true, default, default, false, false);
