...
namespace Buffs
{
    public class GragasBodySlam : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.a, out _, "gragas_bodySlam_cas.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, default, default, false, false);
        ...
        public override void OnMoveEnd()
        {
            ...
            SpellEffectCreate(out hi, out _, "gragas_bodySlam_cas_03.troy", default, teamID, 10, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, target, default, default, true, default, default, false, false);
            numUnits = 0;
            ...
            foreach(AttackableUnit unit in GetUnitsInArea(attacker, attacker.Position, 250, SpellDataFlags.AffectEnemies | SpellDataFlags.AffectNeutral | SpellDataFlags.AffectMinions | SpellDataFlags.AffectHeroes, default, true))
            {
                ...
                if(this.minimumDamage >= damageToDeal)
                {
                    ...
                    SpellEffectCreate(out asdf1, out _, "gragas_bodySlam_unit_tar_02.troy", default, teamID, 10, 10, TeamId.TEAM_UNKNOWN, default, owner, false, unit, "C_BUFFBONE_GLB_CHEST_LOC", default, unit, default, default, true, default, default, false, false);
                    SpellEffectCreate(out asdf2, out _, "gragas_bodySlam_unit_tar.troy", default, teamID, 10, 10, TeamId.TEAM_UNKNOWN, default, owner, false, unit, default, default, unit, default, default, true, default, default, false, false);
