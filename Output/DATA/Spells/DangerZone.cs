...
namespace Buffs
{
    public class DangerZone : BBBuffScript
    {
        ...
        public override void OnActivate()
        {
            ...
            SpellEffectCreate(out this.particle, out _, "corki_valkrie_impact_cas.troy", default, teamOfOwner ?? TeamId.TEAM_UNKNOWN, 900, 0, TeamId.TEAM_UNKNOWN, default, default, false, owner, default, default, target, default, default, false, false, false, false, false);
        }
