...
namespace Buffs
{
    public class SonaSongofDiscordSound : BBBuffScript
    {
        ...
        {
            SpellEffectCreate(out this.part, out _, "SonaSoundofDiscordSound", default, TeamId.TEAM_UNKNOWN, 0, 0, TeamId.TEAM_UNKNOWN, default, owner, false, owner, default, default, owner, default, default, false);
        }
