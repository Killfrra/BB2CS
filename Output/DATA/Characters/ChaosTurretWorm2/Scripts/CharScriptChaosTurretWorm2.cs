...
namespace Chars
{
    public class CharScriptChaosTurretWorm2 : BBCharScript
    {
        public override void OnActivate()
        {
            ...
            AddBuff((ObjAIBase)owner, owner, new Buffs.TurretBonusHealth(nextBuffVars_BonusHealth, nextBuffVars_BubbleSize), 1, 1, 0.01f, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0);
